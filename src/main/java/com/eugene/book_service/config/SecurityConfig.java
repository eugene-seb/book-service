...
import com.eugene.book_service.model.Role;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/category/create/**")
                        .hasAnyRole(ADMIN,
                                    MODERATOR)
                        
                        .requestMatchers("/api/category/update/**")
                        .hasAnyRole(ADMIN,
                                    MODERATOR)
                        
                        .requestMatchers("/api/category/delete/**")
                        .hasRole(ADMIN)
                        
                        .requestMatchers("/api/book/create/**")
                        .hasAnyRole(ADMIN,
                                    MODERATOR)
                        
                        .requestMatchers("/api/book/update/**")
                        .hasAnyRole(ADMIN,
                                    MODERATOR)
                        
                        .requestMatchers("/api/book/delete/**")
                        .hasRole(ADMIN)
